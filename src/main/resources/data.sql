...
--------------------- TRACKING SYSTEM ---------------------------------
insert into employees (id, emp_name,emp_address,emp_email,emp_phone1,emp_phone2,emp_refer) values (1, 'pavan kumar','Amalapuram','pavan.com','9966','1234','karunakar');

--------------------- TRACKING SYSTEM ---------------------------------
insert into task (id, task_name) values (1, 'Add Product');
